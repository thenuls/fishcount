    ...
    <v-container grid-list-xl class="pt-0">
      ...
      <v-layout row wrap justify-center>
        ...
        <!-- <v-flex xs12 md4>
          <v-item>
            <v-card slot-scope="{ active, toggle }" :style="active ? 'border: 2px solid var(--v-primary-base)' : ''" :class="active ? 'elevation-5' : ''" @click="toggle(), resetCroppa()">
              <v-img src="/fishcount/img/type-paper-thumb.jpg" aspect-ratio="2.00"></v-img>
        ...
        <v-flex xs12 md4>
          <v-item>
            <v-card slot-scope="{ active, toggle }" :style="active ? 'border: 2px solid var(--v-primary-base)' : ''" :class="active ? 'elevation-5' : ''" @click="toggle(), resetCroppa()">
              <v-img src="/fishcount/img/type-magnified-thumb.jpg" aspect-ratio="1.00"></v-img>
              <v-card-title primary-title>
                <div>
        ...
        <v-flex xs12 md4>
          <v-item>
            <v-card slot-scope="{ active, toggle }" :style="active ? 'border: 2px solid var(--v-primary-base)' : ''" :class="active ? 'elevation-5' : ''" @click="toggle(), resetCroppa()">
              <v-img src="/fishcount/img/type-microscope-thumb.jpg" aspect-ratio="1.00"></v-img>
              <v-card-title primary-title>
                <div>
...
export default {
  ...
  methods: {
    ...
    loadDemoImage () {
      let image = new Image()
      if (this.imageType === 0) { image.src = '/fishcount/img/type-paper.jpg' }
      if (this.imageType === 1) { image.src = '/fishcount/img/type-magnified.jpg' }
      if (this.imageType === 2) { image.src = '/fishcount/img/type-microscope.jpg' }
