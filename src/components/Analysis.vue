...
<v-window v-model="window" class="elevation-5">
  ...
  <div v-show="drawer">
    <v-card class="mb-2">
      ...
      <v-layout>
        <v-tooltip bottom>
        <template v-slot:activator="{ on }">
        <v-flex class="subheading"><span v-on="on">{{ $t('Minimum Shrimp Size') }}</span></v-flex>
        </template>
        <span>{{ $t("Minimum Shrimp Size Details") }}</span>
        </v-tooltip>
      </v-layout>
      ...
      <v-layout>
        <v-tooltip bottom>
        <template v-slot:activator="{ on }">
        <v-flex class="subheading"><span v-on="on">{{ $t('Maximum Shrimp Size') }}</span></v-flex>
        </template>
        <span>{{ $t('Maximum Shrimp Size Details') }}</span>
        </v-tooltip>
      </v-layout>
      ...
      <v-layout row wrap align-center>
        ...
        <v-flex class="subheading mb-1">
          <span v-on="on">
          <p class="mb-1">{{ $t('Shrimp Size Scale') }}</p>
          <p class="caption my-0"><v-icon small color="rgba(0, 0, 225, 255)">fiber_manual_record</v-icon> {{ $t('Minimum Shrimp Size') }}</p>
          <p class="caption my-0"><v-icon small color="rgba(225, 0, 0, 255)">fiber_manual_record</v-icon> {{ $t('Maximum Shrimp Size') }}</p>
          <p class="caption my-0"><v-icon small color="rgba(100, 100, 100, 255)">fiber_manual_record</v-icon> {{ $t('Too Large / Too Small') }}</p>
          </span>
          </v-flex>
        </template>
        <span>{{ $t('Shrimp Size Scale Details') }}</span>
        </v-tooltip>
  ...
  <v-card>
    ...
    <v-list>
      <v-list-tile>
        <v-list-tile-content class="body-2"><span><v-icon small color="rgba(0, 0, 225, 255)">fiber_manual_record</v-icon>{{ $t('Single Shrimp') }}</span></v-list-tile-content>
    ...
    <v-list-tile>
      <v-list-tile-content class="body-2">{{ $t('Total Shrimp Estimation') }}</v-list-tile-content>
...
<v-dialog v-model="detailsDialog" max-width="500px">
  ...
  <v-card>
    ...
    <v-card-text>
      <v-list>
        <v-list-tile>
          <v-list-tile-content class="body-1">{{ $t('Total Single Shrimp Area') }}</v-list-tile-content>
          <v-list-tile-content class="align-end body-1">{{ this.singlesTotalArea }}</v-list-tile-content>
        </v-list-tile>
        <v-list-tile>
          <v-list-tile-content class="body-1">{{ $t('Single Shrimp Average Size') }}</v-list-tile-content>
          <v-list-tile-content class="align-end body-1">{{ this.singlesAvg }}</v-list-tile-content>
        </v-list-tile>
        <v-list-tile>
          <v-list-tile-content class="body-1">{{ $t('Shrimp Clusters') }}</v-list-tile-content>
          <v-list-tile-content class="align-end body-1">{{ this.clustersCount }}</v-list-tile-content>
        </v-list-tile>
        <v-list-tile>
          <v-list-tile-content class="body-1">{{ $t('Total Shrimp Clusters Area') }}</v-list-tile-content>
        ...
        <v-list-tile>
          <v-list-tile-content class="body-1">{{ $t('Average Shrimp per Cluster') }}</v-list-tile-content>
